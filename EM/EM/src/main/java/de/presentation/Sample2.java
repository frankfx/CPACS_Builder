...
public class Sample2 extends JPanel{
	...
	// Member fields.
	public DefaultPanel panelBundesliga = new MatchDayPanel("test");
	
	// Constructor.
	public Sample2(JDialog frame){
		...
		panelBundesliga = new MatchDayPanel("I am window 1.");
...
//		TextPanel textPanel5 = new TextPanel("I am window 5.");
		...
		Dockable dockable1 = new DefaultDockable("Window1", panelBundesliga, "Window 1", null, DockingMode.ALL);
...
//		Sample2 panel = new Sample2(frame);
