...
public class BundesligaModel {
	...
	public BundesligaModel(){
		...
		mTeams.put(TeamIDEnum.FSV, new TeamModel("Mainz", "mainz.gif"));
		...
		mTeams.put(TeamIDEnum.FCK, new TeamModel("Koeln", "koeln.gif"));
		mTeams.put(TeamIDEnum.Ingol, new TeamModel("Ingolstadt", "ingolstadt.gif"));
		...
		mTeams.put(TeamIDEnum.D89, new TeamModel("Darmstadt", "darmstadt.gif"));
