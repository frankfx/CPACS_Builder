...
public class SQLService {
	...
	public final static String SQL_SELECT_COMPUTE_BALANCE = "select 99.40 + sum(t.winValue) - (select ifnull(sum(t1.expenses), 0) from Tipico t1 where success=0) from Tipico t where success=1;";
