...
public class SQLService {
	...
	public final static String SQL_COMPUTE_BALANCE = "select 42.1 + sum(t.winValue) - (select ifnull(sum(t1.expenses), 0) from Tipico t1 where success=0) from Tipico t where success=1;";
